...
public class AjaxAuthenticationProvider implements AuthenticationProvider {
	...
	public Authentication authenticate(Authentication authentication) throws AuthenticationException {
		 ...
		 * 
		 * List<GrantedAuthority> authorities = roles.stream() .map(authority -> new
		 * SimpleGrantedAuthority(authority.getRoleName()))
	...
	public UserDTO getUserByUserName(String userName) {
		...
		// user = new UserDTO(1l, "mandeep",
		// "$2a$10$T3t6RdRjcEwR44T775jsP.NvbgSKMi7x9r1ORQA9gnx86GE6JDfQe");
		// } else if (userName.equals("harman")) {
		// user = new UserDTO(2l, "harman",
		// "$2a$10$T3t6RdRjcEwR44T775jsP.NvbgSKMi7x9r1ORQA9gnx86GE6JDfQe");
		// }else if (userName.equals("imran")) {
		// user = new UserDTO(3l, "imran",
		// "$2a$10$T3t6RdRjcEwR44T775jsP.NvbgSKMi7x9r1ORQA9gnx86GE6JDfQe");
		// }
		AccountDto accountDto = accountMasterService.findByUserName(userName);
		UserDTO user = new UserDTO(accountDto.getId(), accountDto.getUsername(), accountDto.getPassword());
